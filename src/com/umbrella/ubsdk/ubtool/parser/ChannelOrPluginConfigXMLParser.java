...
public class ChannelOrPluginConfigXMLParser {
	public static ChannelOrPluginConfig parser(String xmlPath) {
		ChannelOrPluginConfig channelConfig = new ChannelOrPluginConfig();
		try {
        	...
        	if(operations != null) {
        		...
        		for(Element operation : operations.elements()) {
        			Operation oper = new ChannelOrPluginConfig().new Operation();
