 ...
 * @author qingshanliao
 */
public class meizu2Script extends BaseScript{
	private static final String TAG=meizu2Script.class.getSimpleName();
	/**
	...
	public void execute(Game game, Channel channel) throws IOException {
		...
		String sourcePath=GAMES_PATH+File.separator+game.getName()+File.separator+"sdk"+File.separator+"meizu2"+File.separator+"payConfig.xml";
