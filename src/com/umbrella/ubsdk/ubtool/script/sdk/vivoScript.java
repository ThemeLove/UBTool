 ...
 *
 */
public class vivoScript extends BaseScript{
	private final String TAG=vivoScript.class.getSimpleName();
	/**
	 * VIVO渠道要将game/sdk/vivo/payConfig.xml中的计费点配置文件copy到打包过程中的Temp/assets/目录下
	 */
	@Override
	public void execute(Game game, Channel channel) throws IOException {
		System.out.println(TAG+"----->execute");
		String sourcePath=GAMES_PATH+File.separator+game.getName()+File.separator+"sdk"+File.separator+"vivo"+File.separator+"payConfig.xml";
