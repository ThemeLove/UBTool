...
//        String gamePath = GAMES_PATH + File.separator + game.getFolder() + File.separator + "game.apk";
        ...
        for (GameChannel gameChannel : gameChannelList)
        {
            ...
            // 清空temp目录
            System.out.println("清空temp目录");
            String tempPath = workPath + File.separator + "temp";
            FileUtil.delete(tempPath);

            // 复制原始文件
            System.out.println("复制原始文件");
...
//            mutiSmali();
    ...
    private static void mutiSmali()
    {
        ...
        try
        {
            ...
            String smalipyPath = "D:\\apktool\\smali.py";
            Process pr = Runtime.getRuntime().exec("C:\\Users\\hepengniu\\AppData\\Local\\Programs\\Python\\Python36\\python.exe " + smalipyPath);
