.class public Lcom/mchsdk/paysdk/f/c/h;
...
.method private a()Ljava/lang/String;
    ...
    const-string v1, "GameRecordListProcess"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "fun# \u6e38\u620f\u5145\u503c\u8bb0\u5f55 params:"
...
.method public a(Landroid/os/Handler;)V
    ...
    invoke-direct {p0}, Lcom/mchsdk/paysdk/f/c/h;->a()Ljava/lang/String;
    ...
    :try_end_15
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_5 .. :try_end_15} :catch_28
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_15} :catch_4c

    :goto_15
    if-eqz p1, :cond_44

    new-instance v1, Lcom/mchsdk/paysdk/f/d/h;

    invoke-direct {v1, p1}, Lcom/mchsdk/paysdk/f/d/h;-><init>(Landroid/os/Handler;)V

    invoke-static {}, Lcom/mchsdk/paysdk/c/a;->a()Lcom/mchsdk/paysdk/c/a;

    move-result-object v2

    invoke-virtual {v2}, Lcom/mchsdk/paysdk/c/a;->z()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, v0}, Lcom/mchsdk/paysdk/f/d/h;->a(Ljava/lang/String;Lcom/lidroid/xutils/http/RequestParams;)V
    ...
    const-string v2, "GameRecordListProcess"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "fun# \u6e38\u620f\u5145\u503c\u8bb0\u5f55 UnsupportedEncodingException:"
    ...
    :cond_44
    const-string v0, "GameRecordListProcess"
