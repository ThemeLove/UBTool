...
.method public static contentLength(Lokhttp3/r;)J
    .registers 3
...
.method public static hasBody(Lokhttp3/aa;)Z
    .registers 7
    ...
    :cond_29
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->contentLength(Lokhttp3/aa;)J
...
.method public static hasVaryAll(Lokhttp3/aa;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/http/HttpHeaders;->hasVaryAll(Lokhttp3/r;)Z
...
.method public static hasVaryAll(Lokhttp3/r;)Z
    .registers 3

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->varyFields(Lokhttp3/r;)Ljava/util/Set;
...
.method public static parseChallenges(Lokhttp3/r;Ljava/lang/String;)Ljava/util/List;
    .registers 12
    ...
    invoke-virtual {p0, v6}, Lokhttp3/r;->a(I)Ljava/lang/String;
    ...
    :cond_1b
    invoke-virtual {p0, v6}, Lokhttp3/r;->b(I)Ljava/lang/String;
...
.method public static receiveHeaders(Lokhttp3/n;Lokhttp3/s;Lokhttp3/r;)V
    .registers 5
    ...
    :cond_5
    invoke-static {p1, p2}, Lokhttp3/m;->a(Lokhttp3/s;Lokhttp3/r;)Ljava/util/List;
    ...
    invoke-interface {p0, p1, v0}, Lokhttp3/n;->a(Lokhttp3/s;Ljava/util/List;)V
...
.method private static varyFields(Lokhttp3/aa;)Ljava/util/Set;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lokhttp3/internal/http/HttpHeaders;->varyFields(Lokhttp3/r;)Ljava/util/Set;
...
.method public static varyFields(Lokhttp3/r;)Ljava/util/Set;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static varyHeaders(Lokhttp3/aa;)Lokhttp3/r;
    .registers 3
    ...
    invoke-virtual {v0}, Lokhttp3/y;->c()Lokhttp3/r;
    ...
    invoke-static {v0, v1}, Lokhttp3/internal/http/HttpHeaders;->varyHeaders(Lokhttp3/r;Lokhttp3/r;)Lokhttp3/r;
...
.method public static varyHeaders(Lokhttp3/r;Lokhttp3/r;)Lokhttp3/r;
    .registers 8

    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->varyFields(Lokhttp3/r;)Ljava/util/Set;
...
.method public static varyMatches(Lokhttp3/aa;Lokhttp3/r;Lokhttp3/y;)Z
    .registers 6

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->varyFields(Lokhttp3/aa;)Ljava/util/Set;
    ...
    invoke-virtual {p1, v0}, Lokhttp3/r;->c(Ljava/lang/String;)Ljava/util/List;
